...
def playAnalyze(play):
    ...
    if 5 in charsInPlay.values() \
        or (4 in charsInPlay.values() and 'J' in charsInPlay.keys()) \
        or (3 in charsInPlay.values() and 'J' in charsInPlay.keys() and charsInPlay['J'] == 2) \
        or (2 in charsInPlay.values() and 'J' in charsInPlay.keys() and charsInPlay['J'] == 3) \
        or ('J' in charsInPlay.keys() and charsInPlay['J'] == 4) \
            : return Play.FIVE_OF_A_KIND
    elif 4 in charsInPlay.values() \
        or (3 in charsInPlay.values() and 'J' in charsInPlay.keys()) \
        or (2 in charsInPlay.values() and 'J' in charsInPlay.keys() and charsInPlay['J'] == 2 and len(charsInPlay) == 3) \
        or ('J' in charsInPlay.keys() and charsInPlay['J'] == 3) \
            : return Play.FOUR_OF_A_KIND
    elif 3 in charsInPlay.values() and 2 in charsInPlay.values() \
        or (2 in charsInPlay.values() and 'J' in charsInPlay.keys() and charsInPlay['J'] == 1 and len(charsInPlay) == 3) \
            : return Play.FULL_HOUSE
    elif 3 in charsInPlay.values() \
        or (2 in charsInPlay.values() and 'J' in charsInPlay.keys()) \
            : return Play.THREE_OF_A_KIND
    elif 2 in charsInPlay.values() and len(charsInPlay) == 3 \
        or (2 in charsInPlay.values() and 'J' in charsInPlay.keys() and len(charsInPlay) == 4) \
        : return Play.TWO_PAIR
    elif 2 in charsInPlay.values() \
        or ('J' in charsInPlay.keys() and len(charsInPlay) == 5) \
